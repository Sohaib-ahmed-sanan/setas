...
<div class="container-fluid">
    ...
    if(isset($_GET['Id'])){
        $id = $_GET['Id'];
        $query = " UPDATE `client_booking` SET `splitor`= 1 WHERE client_id = $id ";
...
<div class="container-fluid text-center pt-4 pb-3">
    ...
    <p>Following is the list of rejected orders.</p>
    <table class="table">
        <thead>
            <tr>
                <th>Sno</th>
        ...
        <tbody>
            ...
            $select = "SELECT * FROM `client_booking` where `splitor` = 2";
            ...
            while ($row = mysqli_fetch_assoc($triger)) { ?>
                <tr>
                    ...
                    <td>
                    <a href="confirm_order.php?Id=<?php echo $row["client_id"] ?>" class="btn btn-success">Confirm</a> 
                    </td>
                </tr>
            <?php $i++;
            } ; ?>
